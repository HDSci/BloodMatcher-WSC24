...
def antigens():
    ...
    matching_antigens = load_rule_sets('BSCSimulator/experiments/matching_rules.json')['MATCHING_RULES']['Extended']['antigen_set']
    alloantibodies = load_alloantibodies()
    immuno = load_immunogenicity()
    
    Antigens.population_abd_usabilities = abd_usability()
    antigens = Antigens(ANTIGENS, rule=matching_antigens, allo_Abs=alloantibodies.flatten())
